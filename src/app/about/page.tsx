        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <Card className="border-2">
            ...
            <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                My passion for economics education stems from my own transformative learning experience. I remember
                struggling with abstract economic concepts until a dedicated teacher took the time to explain them
                through real-world examples and patient guidance. That moment sparked my love for the subject and
                inspired me to help others experience the same clarity and excitement.
              </p>
              <p>
                Throughout my academic journey, I've consistently sought opportunities to share my knowledge with
                peers through informal tutoring and study groups. Witnessing the "lightbulb moment" when a concept
                finally clicks for a student is incredibly rewarding and reinforces my desire to pursue teaching as a
                career.
              </p>
              <p>
                I believe economics is more than just graphs and theories - it's a lens through which we understand the
                world around us. From daily decisions about spending to major policy debates affecting millions,
                economic thinking empowers students to be informed, critical citizens. This is the perspective I want to
                bring to my future students.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2">
            ...
            <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                ...
                provide a comprehensive, well-organized collection specifically tailored to the Singapore syllabus for
                both secondary and JC levels. Students often struggle to find quality materials that progressively build
                understanding.
              </p>
              <p>
                This project represents hundreds of hours of work - researching syllabus requirements, crafting clear
                explanations, developing model answers, and organizing content in an accessible way. Each note, essay,
                and question has been carefully designed to help students not just memorize, but truly understand
                economic concepts.
              </p>
              <p>
                Beyond demonstrating my subject knowledge, this platform showcases my commitment to accessibility and
                student-centered learning. I've organized resources by difficulty, provided multiple pathways to explore
                content, and included detailed explanations that anticipate common misconceptions.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 bg-primary/5">
            ...
            <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
              ...
              <p>
                ...
                This project itself demonstrates my willingness to go beyond traditional methods and leverage technology
              ...
              <p>
                ...
                me. I believe that great teachers don't just teach content - they ignite curiosity, build confidence, and
