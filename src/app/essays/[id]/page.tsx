            ...
            <div className="absolute top-0 right-0 p-4 flex gap-2">
               <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-amber-100 dark:bg-amber-900/40 border border-amber-200 dark:border-amber-800/60 shadow-sm transition-all hover:scale-[1.02]">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[9px] font-bold text-amber-700 dark:text-amber-300 uppercase leading-none">Marks</span>
                    <span className="text-xs font-black text-amber-800 dark:text-amber-200">{essay.marks}</span>
                  </div>
                </div>
                <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-indigo-100 dark:bg-indigo-900/40 border border-indigo-200 dark:border-indigo-800/60 shadow-sm transition-all hover:scale-[1.02]">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[9px] font-bold text-indigo-700 dark:text-indigo-300 uppercase leading-none">Target</span>
                    <span className="text-xs font-black text-indigo-800 dark:text-indigo-200">{Math.ceil(parseInt(essay.marks) * 1.5)}m</span>
                  </div>
                </div>
            </div>
