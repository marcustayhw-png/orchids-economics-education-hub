...
<Card className="border-2 shadow-sm bg-card/50 backdrop-blur-sm h-full">
<CardHeader className="pb-2">
      ...
      <div className="space-y-6">
        <Card className="border-2 shadow-sm bg-primary/5 text-primary-foreground h-full md:h-auto">
          <CardHeader className="pb-2">
        ...
        <div className="pt-4 px-2 hidden md:block lg:hidden xl:block">
